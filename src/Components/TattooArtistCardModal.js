...
const TattooArtistCardModal = (props) => {
  return (
      ...
      <CardBody>
        <Row>
          <Col xs="4" id="artistInfoLeftBoxModal">
            ...
            <Button outline color="success" size="sm" className="artistButtonModal"> <FontAwesomeIcon icon={faEnvelope} className="fa-xs"/> Contacter</Button>
          </Col>
          <Col xs="8">
